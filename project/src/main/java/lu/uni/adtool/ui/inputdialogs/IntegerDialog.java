 ...
 * @author Piotr Kordy
 */
public class IntegerDialog extends InputDialog {
   ...
   *          parent frame.
   */
  public IntegerDialog(final Frame frame) {
    super(frame, Options.getMsg("inputdialog.anyintnumber.txt"));
    infButton = null;
  }
   ...
   *          window title.
   */
  public IntegerDialog(final Frame frame, final String title) {
    super(frame, title);
  }
  ...
  // final int bound = ((Integer)value).getBound();
  // if(new Double(d).isInfinite()){
  // value = new Integer(Integer.INF,bound);
  // valueField.setValue(value);
  // }
  // else if(d >= 0 && d<=bound){
  // value = new Integer((int)d,bound);
  // valueField.setValue(((Integer)value).getValue());
  // }
  // else{
  // error = true;
  // valueField.setValue(new Integer(((Integer)value).getValue()));
  // }
  // }
  // return error;
  // }
  ...
  protected void createLayout(final boolean showDefault) {
    errorMsg.setText(Options.getMsg("inputdialog.anyintnumber.error")+ ".");
