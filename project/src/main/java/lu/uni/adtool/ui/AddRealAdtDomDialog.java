...
public class AddRealAdtDomDialog extends JDialog implements ActionListener, DocumentListener {

  public enum FieldType {
    AP, AO, OP, OO, CP, CO, NAME, DESCR, NONE, DEFAULTP, DEFAULTO, PRECISION
  }

  public AddRealAdtDomDialog(Frame frame, AdtRealDomain domain) {
  ...
  public boolean checkValid(JTextField field) {
    ...
    if (this.name.getBackground() == AddRealAdtDomDialog.validColor
        && this.defaultp.getBackground() == AddRealAdtDomDialog.validColor
        && this.defaulto.getBackground() == AddRealAdtDomDialog.validColor
        && this.description.getBackground() == AddRealAdtDomDialog.validColor
        && this.ao.getBackground() == AddRealAdtDomDialog.validColor
        && this.ap.getBackground() == AddRealAdtDomDialog.validColor
        && this.oo.getBackground() == AddRealAdtDomDialog.validColor
        && this.op.getBackground() == AddRealAdtDomDialog.validColor
        && this.co.getBackground() == AddRealAdtDomDialog.validColor
        && this.cp.getBackground() == AddRealAdtDomDialog.validColor
        && this.precision.getBackground() == AddRealAdtDomDialog.validColor) {
